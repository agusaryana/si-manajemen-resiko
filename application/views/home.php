...
<body class="landing is-preload">
	...
	<div id="page-wrapper">
		...
		<section id="banner">
			<div class="inner">
				<!-- <h2><?php echo $dataorg['short_org'] ?></h2> -->
				<h2>SIMARKO</h2>
				<p>SISTEM INFORMASI MANAJEMEN RESIKO<br /></p>
				<ul class="actions special">
					<!-- link login guest -->
					<li><a href="<?php echo base_url() ?>login" class="button">USER INPUTER</a></li>
					<li><a href="<?php echo base_url() ?>troubleshoot" class="button">USER Unit Penanggung Jawab</a></li>
				</ul>
			</div>
		</section>
		...
		<footer id="footer">
			<ul class="copyright">
				<li>&copy; 2023</li>
				<li> <?php echo $dataorg['nama_org'] ?></li>
			</ul>
		</footer>
