					...
					<ul class="nav metismenu" id="side-menu">
						...
						<li class="active">
							...
							<ul class="nav nav-second-level collapse">
								<li class="active"><a href="<?php echo base_url() ?>ts/ticket"><i class="fa fa-inbox"></i> Request Masuk</a></li>
				...
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">
							<strong>Data Request Open</strong>
						</li>
					</ol>
				</div>
				<div class="col-lg-2">
										...
										<tbody>
											...
											foreach ($ticket as $l) { ?>
												<tr>
													...
													<td>
														<button type="button" class="btn btn-danger btn-xs timeline" data-ticket-id="<?php echo $l->no_ticket ?>" title="Status Ticket">Open</button>
													</td>
													<td>
														<button type="button" class="btn btn-success btn-xs detail" data-ticket-id="<?php echo $l->id_ticket ?>" title="Deskripsi Ticket"><i class="fa fa-eye"></i> Detail</button> | <button type="button" class="btn btn-warning btn-xs exeticket" data-ticket-id="<?php echo $l->id_ticket ?>" title="Ambil Ticket"><i class="fa fa-warning"></i> Penyelesaian</button> |
														<!-- <button type="button" class="btn btn-danger btn-xs approval" data-ticket-id="<?php echo $l->id_ticket ?>" title="Approval Request"><i class="fa fa-danger"></i> Approve</button> -->
													</td>
												</tr>
											<?php } ?>
										</tbody>
			...
			<div class="modal-dialog">
				<div class="modal-content animated fadeIn">
					<div class="modal-header">
						...
						<!-- <i class="fa fa-ticket modal-icon"></i> -->
						<h4 class="modal-title">Penyelesaian LED</h4>
						<small>Lost Event Database</small>
					</div>
