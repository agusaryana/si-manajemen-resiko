...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav metismenu" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="<?php echo base_url() ?>ts/divisi"><i class="fa fa-user-md"></i> Data Divisi</a></li>
                ...
                <div class="row">
                    ...
                    <div class="ibox ">
                        <div class="ibox-title">
                            <button class="btn btn-primary dim" type="button" data-toggle="modal" data-target="#adddivision" ><i class="fa fa-user-md"></i> Tambah Divisi</button>
                        </div>
                        <div class="ibox-content">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-division" id="table-division">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Nama Divisi</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($l->sts_div == 1){
                                                    echo '<button type="button" class="btn btn-primary btn-xs active" data-div-id="'.$l->id_div.'" title="Divisi Aktif"><i class="fa fa-check"></i> Aktif</button>';
                                                }else{
                                                    echo '<button type="button" class="btn btn-danger btn-xs nonactive" data-div-id="'.$l->id_div.'" title="Divisi Non-Aktif"><i class="fa fa-exclamation-triangle"></i> Non-Aktif</button>';
                                                }
                                                ?>
                                            </td>
                                            <td><button type="button" class="btn btn-warning btn-xs editdiv" data-div-id="<?php echo $l->id_div ?>" title="Edit Divisi"><i class="fa fa-edit"></i></button> | 
                                                <button type="button" class="btn btn-danger btn-xs deletediv" data-div-id="<?php echo $l->id_div ?>" title="Hapus Divisi"><i class="fa fa-trash"></i></button>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
        ...
        <!-- Modals -->
        <div class="modal inmodal" id="adddivision" tabindex="-1" role="dialog"  aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content animated fadeIn">
                    <div class="modal-header">
                        ...
                        <small>Silakan buat divisi baru jika organisasi anda memiliki banyak divisi.</small>
                    </div>
                    <form role="form" id="form" method="POST" action="<?php echo base_url()?>ts/divisi/add">
                        <div class="modal-body">
                                <div class="form-group">
                                    <label>Nama Divisi</label>
                                    <input type="text" name="nama_div" placeholder="Masukkan Nama Divisi" class="form-control" required>
                                </div>
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content animated fadeIn">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Aktivasi Divisi</h4>
                        <small>Anda akan merubah status divisi</small>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content animated fadeIn">
                    <div class="modal-header">
                        ...
                        <small>Anda akan merubah nama divisi</small>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content animated fadeIn">
                    <div class="modal-header">
                        ...
                        <small>Anda akan menghapus Divisi</small>
                    </div>
    ...
    <script>
			$("#table-division").on('click', '.active', function(e) {
                e.preventDefault();
                var div_id = $(e.currentTarget).attr('data-div-id');
                if (div_id === '') return;
                $.ajax({
                    type: "POST",
                    url: '<?= base_url('ts/divisi/ajax?type=nonactive'); ?>',
                    data: {
                        div_id: div_id
                    },
                    beforeSend: function() {
            ...
            $("#table-division").on('click', '.nonactive', function(e) {
                e.preventDefault();
                var div_id = $(e.currentTarget).attr('data-div-id');
                if (div_id === '') return;
                $.ajax({
            ...
            $("#table-division").on('click', '.editdiv', function(e) {
                e.preventDefault();
                var div_id = $(e.currentTarget).attr('data-div-id');
                if (div_id === '') return;
                $.ajax({
                    type: "POST",
                    url: '<?= base_url('ts/divisi/ajax?type=editdiv'); ?>',
                    data: {
                        div_id: div_id
                    },
                    beforeSend: function() {
            ...
            $("#table-division").on('click', '.deletediv', function(e) {
                e.preventDefault();
                var div_id = $(e.currentTarget).attr('data-div-id');
                if (div_id === '') return;
                $.ajax({
                    type: "POST",
                    url: '<?= base_url('ts/divisi/ajax?type=deletediv'); ?>',
                    data: {
                        div_id: div_id
                    },
                    beforeSend: function() {
