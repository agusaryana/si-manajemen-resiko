                    ...
                    <ul class="nav metismenu" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="<?php echo base_url() ?>ts/email"><i class="fa fa-envelope"></i> Konfig Email</a></li>
                ...
                <div class="row">
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    <div class="col-sm-12 b-r">
                                        <form role="form" method="POST" action="<?php echo base_url() ?>ts/email/update">
                                            <input type="hidden" name="id_email" value="<?php echo $dataemail['id_email'] ?>">
                                            <div class="form-group">
                                                <label>Alamat Email</label> 
                                                <input type="email" placeholder="Masukan alamat email anda" class="form-control" name="alamat_email" value="<?php echo $dataemail['alamat_email'] ?>" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Passsword Email</label> 
                                                <input type="password" placeholder="Masukan password email anda" class="form-control" name="pass_email" value="<?php echo $dataemail['pass_email'] ?>" required>
                                            </div>
                                            <div class="form-group">
                                                <label>SMTP Host</label> 
                                                <input type="text" placeholder="Masukan SMTP Out host email anda" class="form-control" name="smtphost_email" value="<?php echo $dataemail['smtphost_email'] ?>" required>
                                            </div>
                                            <div class="form-group">
                                                <label>SMTP Port</label> 
                                                <input type="text" placeholder="Masukan SMTP PORT email anda" class="form-control" name="smtpport_email" value="<?php echo $dataemail['smtpport_email'] ?>" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Status</label>
                                                <select class="form-control m-b" name="sts_email">
                                                    <option selected="selected" value="<?php echo $dataemail['sts_email'] ?>">
                                                        <?php
                                                            if($dataemail['sts_email'] == 1){
                                                                echo "Aktif";
                                                            }else{
                                                                echo "Non-Aktif";
                                                            }
                    ...
                    <div class="col-lg-5">
                        <div class="ibox ">
                            ...
                            <div class="ibox-content">
                                <p>1. Silakan isi konfigurasi whatsapp ini sesuai dengan email hosting yang anda punya.</p>
                                <p>2. Jika anda tidak memiliki email, silakan non-aktifkan statusnya agar tidak error.</p>
                                <p>3. Email gratis seperti Google, Yahoo, dll sudah tidak optimal untuk digunakan pada konfigurasi ini.</p>
                            </div>
                        </div>
                    </div>
                </div>
