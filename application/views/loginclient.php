...
<body class="gray-bg">
	...
	<div class="middle-box text-center loginscreen animated fadeInDown">
		<div>
			...
			<h3>SIMARKO</h3>
			<h3><b>Login Inputer</b></h3>
			<form class="m-t" role="form" action="<?php echo base_url() ?>login/auth" method="POST">
				<div class="form-group">
					<input type="text" name="username_client" class="form-control" placeholder="Username" required>
				</div>
				<div class="form-group">
					<input type="password" name="pass_client" id="pass_client" class="form-control" placeholder="Password" required>
	...
	<script>
		...
		function togglePassword() {
			var passwordField = document.querySelector("#pass_client");
